...
set_can_baudrate = [
    ...
    0x08,     #  3 CAN Baud Rate:  500kbps  ##  0x01(1Mbps),  0x02(800kbps),  0x03(500kbps),  0x04(400kbps),  0x05(250kbps),  0x06(200kbps),  0x07(125kbps),  0x08(100kbps),  0x09(50kbps),  0x0a(20kbps),  0x0b(10kbps),   0x0c(5kbps)##
...
while True:
    ...
    if (data[0] == 0xaa) and (data[1] & 0xc0 == 0xc0):  # frame header
        ...
        if data2[len2 - 1] == 0x55:  # end code
            ...
            # --- NEW: try to decode payload as ASCII and reassemble "Hello world" ---

            # Only bother for frames that have data
            if CanData != ["No Data"]:
                # Convert list like ['0x48','0x65',...] -> bytes
                try:
